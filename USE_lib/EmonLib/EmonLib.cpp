...
{
   current(_inPinI,_ICAL,1,0);
}

void EnergyMonitor::current(unsigned int _inPinI, double _ICAL,float Curr_slope,float Curr_intercept)
{
  inPinI = _inPinI;
  ICAL = _ICAL;
  offsetI = ADC_COUNTS>>1;
  slope = Curr_slope;
  y_intercept = Curr_intercept;
}
