...
void Page_2(EthernetClient client) { //----configuure page start----------
  ...
  client.print("NTP SERVER_____________: <INPUT TYPE=TEXT NAME='NTP_SERVER' VALUE='"); client.print(String(running_val.NTPserver));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("MQTT SERVER___________: <INPUT TYPE=TEXT NAME='MQTT_SERVER' VALUE='"); client.print(String(running_val.mqtt_server));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("MQTT PORT______________: <INPUT TYPE=TEXT NAME='MQTT_PORT' VALUE='"); client.print(String(running_val.mqtt_port));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("COMPANY NAME_________: <INPUT TYPE=TEXT NAME='CompanyNm' VALUE='"); client.print(String(running_val.CompanyNm));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("DEPARTMENT_NAME_____: <INPUT TYPE=TEXT NAME='DepartNm' VALUE='"); client.print(String(running_val.DepartNm));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("DEVICE_ID_______________: <INPUT TYPE=TEXT NAME='DeviceID' VALUE='"); client.print(String(running_val.DeviceID));
  client.println("' SIZE='25' MAXLENGTH='50' readonly>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("DEVICE_NO.______________: <INPUT TYPE=TEXT NAME='DeviceNo' VALUE='"); client.print(String(running_val.DeviceNo));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("ALERT TIME______________: <INPUT TYPE=TEXT NAME='Alert_tm' VALUE='"); client.print(String(running_val.Alert_tm));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("DELTA CURRENT__________: <INPUT TYPE=TEXT NAME='Delta_Curr' VALUE='"); client.print(String(running_val.Delta_Curr));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("DELTA TIME_______________: <INPUT TYPE=TEXT NAME='Delta_tm' VALUE='"); client.print(String(running_val.Delta_tm));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.print("CT_Ratio__________________: <INPUT TYPE=TEXT NAME='CT_Ratio' VALUE='"); client.print(String(running_val.CT_Ratio));
  client.println("' SIZE='25' MAXLENGTH='50'>");
  client.println(F("<INPUT   TYPE=SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));

  client.println(F("<FORM ACTION='/' method=get >")); //uses IP/port of web page
  client.println(F("CONFIGURE DEFAULT_____: <INPUT TYPE=TEXT NAME='CONFIG_DEFAULT' VALUE='DEFAULT' SIZE='25' MAXLENGTH='50'>"));
  client.println(F("<INPUT TYPE = SUBMIT NAME='submit' VALUE='Submit'>"));
  client.println(F("</FORM>"));
...
void Update_Field(String ReadString) {
  ...
  if (ReadString.indexOf("CT_Ratio") > 1) {
    ...
    if (temp.length() <= (Reserved_pvt_bytes - _ADDR_CT_Ratio )) {
